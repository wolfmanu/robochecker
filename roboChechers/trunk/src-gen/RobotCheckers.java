	...
	import lejos.navigation.*;
     public class RobotCheckers extends Statemachine{
        ...
        public RobotCheckers(){this(null);} 
      ...
      new ITransition[] {
         ...
         {public boolean guard(){return robotWin==false;}
               
         }
      ,
         new AbstractTransition(robotWins)
         {public boolean guard(){return robotWin==true;}
      ...
      robotWins.setImplicitTransitions(
      new ITransition[] {
      ...
      new ITransition[] {
         ...
         new AbstractTransition(guessMoveFrom)
         {public boolean guard(){return colore==CheckersConstants.BLACK && searchFrom==true;}
               
         }
      ,
         new AbstractTransition(calculateTo)
         {public boolean guard(){return colore==CheckersConstants.WHITE && searchFrom==true;}
      ...
      calculateTo.setImplicitTransitions(
      new ITransition[] {
      ...
      new ITransition[] {
         ...
         {public boolean guard(){return humanWin==true;}
               
         }
      ,
         new AbstractTransition(showFrom)
         {public boolean guard(){return humanWin==false;}
      ...
      humanWins.setImplicitTransitions(
      new ITransition[] {
      ...
      new ITransition[] {
         ...
         {public boolean guard(){return ;}
          public int getDelay(){return 3000;}     
           ...
           setStartTransitions(new ITransition[] {
  		 new ITransition(){
  		   final public boolean guard(){return true;}
  		   final public IState getTarget(){return calibration;}
  		   final public int getDelay(){return 0;}
  		}
		...
		**/
	     ...
	     private fullyQuallyfiedTypeName newVariable = new Type();
      ...
      public  IState calibration = new  AbstractState(this){
           ...
           public void entryMethod(){
                 NXTCommHandle.getInstance().connect(); arm.down();
           } 
           
           final public String getName(){return "Calibration";}  
      }; 
...
while(true){if (Thread.interrupted())
		  ...
		  Thread.yield();	
           ...
           final public String getName(){return "Home";}  
      }; 
	...
	board.getPossibleMoves(piecehuman);
           ...
           final public String getName(){return "CalculateMoves";}  
      }; 
      ...
      public  IState robotWins = new  AbstractState(this){
           ...
           final public String getName(){return "RobotWins";}  
      }; 
      ...
      public  IState guessMoveFrom = new  AbstractState(this){
           ...
           final public String getName(){return "GuessMoveFrom";}  
      }; 
      ...
      public  IState sensorRead = new  AbstractState(this){
           ...
           final public String getName(){return "SensorRead";}  
      }; 
      ...
      public  IState updateBoard = new  AbstractState(this){
           ...
           final public String getName(){return "UpdateBoard";}  
      }; 
...
searchTo = true;
           ...
           final public String getName(){return "CalculateTo";}  
      }; 
...
navigator.goTo(to[to.length - 1]);
           ...
           final public String getName(){return "GuessMoveTo";}  
      }; 
      ...
      public  IState think = new  AbstractState(this){
           ...
           public void doMethod() throws InterruptedException{
                 Engine.MiniMax(board.getArrayBoard(), 0, depth, result, pieceRobot,new int[1]);
try {
nextMove = Move.fromArray(result);
           ...
           final public String getName(){return "Think";}  
      }; 
      ...
      public  IState humanWins = new  AbstractState(this){
           ...
           final public String getName(){return "HumanWins";}  
      }; 
      ...
      public  IState showFrom = new  AbstractState(this){
           ...
           final public String getName(){return "ShowFrom";}  
      }; 
      ...
      public  IState showTo = new  AbstractState(this){
           ...
           final public String getName(){return "ShowTo";}  
      }; 
      ...
      public ITransition humanMoved = new AbstractTransition(calculateMoves){
        ...
        **/
        public static void main(String[] args){
               ...
               StateChangeListener[] allListeners = 
                  new StateChangeListener[] {new LCDChangeListener() , new BTChangeListener() };
        ...
        final public String getName(){return "RobotCheckers";}
