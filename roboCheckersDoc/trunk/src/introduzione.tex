...
Il progetto è basato sui Lego\textregistered~Mindstorms NXT.

\paragraph{}
Dal punto di vista software, considerata la complessità non banale di ciò che
si intendeva realizzare, si è deciso di utilizzare un linguaggio di
...
\emph{Lejos}.\\ È possibile scaricare dal sito web di \emph{Lejos}
(\url{http://lejos.sourceforge.net}) un plugin da integrare nell'ambiente di sviluppo \emph{Eclipse}
(\url{http://www.eclipse.org}), che l'intero processo di programmazione.

\paragraph{}
Come secondo obiettivo, si è scelto di implementare nel Robot il medesimo
...
Per raffrontare quanto si troverà scritto più avanti con il codice allegato a
questa relazione, si tenga presente che la parte di progetto che poggia
direttamente su \emph{Lejos} è denominata \texttt{RoboCheckersNXJ}, mentre
