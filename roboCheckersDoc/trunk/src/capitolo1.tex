...
ellisse che nel modello presentato è stato approssimato ad una circonferenza.\\
La stima del raggio è pertanto soggetta ad un'incertezza superiore al 4\%, $r=12\pm0.5$ cm e l'errore finale che 
ne deriva dipende dalla posizione iniziale del Robot (perchè cambiano i parametri dell'ellisse) arrivando a
