...
\end{lstlisting}
Si noti come i metodi che comportano un movimento non possano essere eseguiti se prima non è stata effettuata la calibrazione (eccezione \texttt{NotCalibratedException}).\\
