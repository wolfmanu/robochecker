...
esponenzialmente con la profondità di ricerca ed è pari $\overline{m}^d$ (dove
$\overline{m}$ è il numero medio di mosse possibili e $d$ è la profondità)
determinando una complessità NP completa.
