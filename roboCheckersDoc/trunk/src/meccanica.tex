...
barre che 'leghino' i due montanti insieme. Nello specifico ne sono state
montate tre: una sulla punta del braccio, una sul montante anteriore ed una sul
montante posteriore.

\section{Sistema di leve a forbice}

Per la costruzione della parte terminale del braccio si è dovuto risolvere due
problemi: il primo è stato sul come generare un moto verticale, che abbassi la punta del braccio da
un moto rotatorio. Il secondo, e strettamente correlato al primo, è stato il
come dare la giusta precizione in modo che il sensore sia sempre alla stessa
altezza dalla scacchiera. \\
