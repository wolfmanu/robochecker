...
Per la costruzione della parte terminale del braccio si è dovuto risolvere due
problemi: il primo è stato sul come generare un moto verticale, che abbassi la
punta del braccio da un moto rotatorio. Il secondo, e strettamente correlato al
primo, è stato il come dare la giusta precizione in modo che il sensore sia
sempre alla stessa altezza dalla scacchiera. \\

Il per il primo problema si è deciso di risolverlo tramite un sitema di
...
ingranaggi gemelli, ogniuno montato rispettivamente nel punto di ancoraggio
delle braccia del pantografo. Figura \ref{leve}

  		\begin{figure}
          \begin{center}		
			\includegraphics[scale=0.4]{img/leve.png}
			\caption{Sistema di leve a forbice \label{leve}}
		  \end{center}
		\end{figure} 

Per risolvere il problema della precisione di nella discesa, problema in parte
risolto dall'adozione del pantografo, si è inserito un gioco d'ingranaggi
Figura \ref{ingranaggi} che riducono i giri del motore di NUMERODACALCOLARE
volte, in modo da ottenere un numero di giri sufficientemente elevato
da permettere una stima empirica del comando da impartire al motore.\\

  		\begin{figure}
          \begin{center}		
			\includegraphics[scale=0.4]{img/ingranaggi.png}
			\caption{Gioco di ingranaggi \label{ingranaggi}}
		  \end{center}
		\end{figure} 

Il pantografo è inoltre dotato di due sensori: il primo, situato sotto il gioco
di ingranaggi, ed è qundi solidale con il braccio, è il sensore di pressione
