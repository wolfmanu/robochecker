...
giovatori non ha più mosse possibili, gli stati \texttt{CalculateMoves} e
...
A pagina seguente si allega l'immagine della macchina a stati.
...
\item[Difficoltà di editing degli stati] durante l'editing degli stati mediante
la finestra \emph{Properties} non è possibile andare a capo premendo invio
(l'unico modo per forzare un \emph{line break} è inserire il carattere di carriage return,
